public class Detection
{
  ...
  {
    return Area(aX, aY, bX, bY, cX, cY) - (Area(aX, aY, bX, bY, px, py) + Area(bX, bY, cX, cY, px, py) + Area(cX, cY, aX, aY, px, py)) <= 2 && Area(aX, aY, bX, bY, cX, cY) - (Area(aX, aY, bX, bY, px, py) + Area(bX, bY, cX, cY, px, py) + Area(cX, cY, aX, aY, px, py)) >= -1 ? true : false;
  }
